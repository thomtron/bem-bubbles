...
int main() {
    ...
    Bem::real radius   = 110e-6; // m 
    Bem::real pressure = 4e3; // Pa
    string folder = "/cluster/home/threnggli/results/f=30e3_r=110e-6_p=4e3_beta=0.2_rem=0.12_epsilon=1e-2_b-nonlin-0.01-smo/";
