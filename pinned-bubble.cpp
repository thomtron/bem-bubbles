...
int main() {
    ...
    Bem::real radius   = 89e-6; // m 
    Bem::real pressure = 2.1e3; // Pa
    string folder = "/cluster/home/threnggli/results/f=30e3_r=89e-6_p=2.1e3_beta=0.2_rem=0.1_epsilon=1e-2_b-nonlin-0.01-smo-fine/";
