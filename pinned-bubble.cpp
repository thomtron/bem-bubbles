...
int main() {
    ...
    Bem::real pressure = 3.4e3; // Pa
    string folder = "/cluster/home/threnggli/results/f=30e3_r=90e-6_p=3.4e3_beta=0.2_rem=0.1_epsilon=1e-2_b-nonlin-0.01-smo-fine-slow/";
