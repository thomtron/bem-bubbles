...
int main() {
    ...
    Bem::real radius   = 85e-6; // m 
    Bem::real pressure = 1.5e3; // Pa
    string folder = "/cluster/home/threnggli/results/f=30e3_r=85e-6_p=1.5e3_beta=0.2_rem=0.12_epsilon=1e-2_b-nonlin-0.01-smo/";
